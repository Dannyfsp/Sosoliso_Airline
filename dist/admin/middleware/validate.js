...
const validateMiddleware = (req, res, next) => {
    ...
    switch (true) {
        ...
        case !flightType:
            return res.status(400).json({
                message: "Flight type is required and must be either international or local",
            });
        ...
        case !availableSeatsFirstClass:
            return res.status(400).json({
                message: "Available seats of first class is required and must be a number",
            });
        ...
        case !availableSeatsBusinessClass:
            return res.status(400).json({
                message: "Available seats of business class is required and must be a number",
            });
        ...
        case !availableSeatsEconomyClass:
            return res.status(400).json({
                message: "Available seats of economy class is required and must be a number",
            });
